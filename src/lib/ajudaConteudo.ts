...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    regras: [
      ...
      "Ao final das linhas de forma de pagamento, duas linhas discretas de subtotal podem fechar a janela: \"Subtotal\" (soma das formas de pagamento marcadas — bate com o \"Total de gastos no mês\" quando todas estiverem marcadas) e \"Provisão Líquido\" (tudo que já está lançado a receber no mês, mesmo o que ainda não foi marcado como recebido, menos esse subtotal — é uma projeção, não o líquido já efetivado). As duas seguem o mesmo ícone de olho que mostra/oculta os totalizadores do topo, mas só aparecem se a opção \"Subtotal e Provisão na tela de Início\" estiver ativada em Configurações → Geral I (desativada por padrão).",
    ...
    marcadores: [
      ...
      { numero: 6, xPct: 89.2, yPct: 20.7, texto: "Oculta ou mostra a Janela de 10 meses." },
      {
        ...
        yPct: 70.8,
        texto:
          "Mini-dashboard: valor, quantidade de lançamentos e aplicações das formas de pagamento marcadas. Mostrar/ocultar e escolher pizza ou barras agora fica em Configurações → Geral I.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    regras: [
      "É preciso marcar ao menos uma opção em Forma de pagamento para a lista aparecer — evita mostrar tudo de uma vez sem querer. Os filtros Aplicação, Reembolso, Provisão e Valor ficam sempre visíveis, mas só ficam ativos depois de marcar alguma forma de pagamento (Aplicação e Reembolso desativam de novo se \"Provisão\" for marcado, já que provisão não usa esses filtros). Se todas as formas de pagamento forem desmarcadas, \"Provisão\" também é desmarcado automaticamente, para não ficar um filtro marcado sem nenhuma forma de pagamento selecionada.",
      "Os filtros de múltipla escolha (Forma de pagamento, Aplicação, Reembolso) mostram um rodapé fixo com o total de opções da lista, mesmo quando é preciso rolar para ver todas — assim fica claro que não falta nada, só está rolável.",
    ...
    marcadores: [
      { numero: 1, xPct: 10, yPct: 22.8, texto: "Filtros por forma de pagamento, aplicação, reembolso, provisão e valor." },
  ...
  },
  {
    ...
    regras: [
      ...
      "Ao lançar um recebido: o Credor vem travado com o nome de quem enviou (abreviado se for muito longo), a observação é copiada do lançamento original, e o lançamento nunca é do tipo Provisão nem tem reembolso associado — por isso a Provisão não aparece nas opções de forma de pagamento desse fluxo.",
      "Selecionar vários recebidos e clicar em Lançar abre um processo sequencial: um lançamento de origem por vez (mesmo que ele tenha várias parcelas), mostrando \"Lançamento X de Y\", o credor e o valor total daquele lançamento. Para cada um você escolhe a forma de pagamento e a aplicação (a aplicação já vem pré-selecionada com a sugestão de quem enviou, se ela já existir na sua lista, ou com a primeira da sua lista) e clica em \"Lançar e ir para o próximo\" — só nesse clique aquele item específico é efetivamente gravado em Contas a Pagar; os demais continuam esperando sua vez. A forma de pagamento escolhida fica marcada como padrão para o próximo item, pra não precisar reselecionar toda hora.",
  ...
  },
  {
    ...
    resumo:
      "Personalização das listas usadas nos formulários (formas de pagamento e aplicações) e preferências gerais: resumos do relatório, sugestão de credor, itens por página, menu, mini-dashboard da Início e tema.",
    regras: [
      ...
      "O card \"Mini-dashboard na tela de Início\" controla o mini-dashboard de formas de pagamento que aparece no final da tela Início: a chave liga/desliga a exibição dele lá, e os botões escolhem entre pizza ou barras nos três gráficos. Cada quadro fica do tamanho do gráfico (a lista de nomes rola com o mouse dentro do próprio quadro, sem cortar linha). Em monitores com pouca altura de tela, ele se adapta automaticamente: primeiro troca os gráficos por uma lista simples com os mesmos valores e, se ainda faltar espaço, a Janela de 10 meses deixa de ficar fixa e passa a rolar junto — só os totalizadores e os filtros de forma de pagamento continuam fixos no topo — garantindo que o mini-dashboard sempre possa ser alcançado rolando a tela.",
