...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    titulo: "Início",
    resumo:
      "Tela inicial: totalizadores do mês, filtro por forma de pagamento, Janela de 10 meses (com link para os lançamentos) e um mini-dashboard das formas de pagamento marcadas.",
    regras: [
    ...
    marcadores: [
      ...
      { numero: 2, xPct: 82.9, yPct: 11.8, texto: "Mostra/oculta os valores e navega entre os meses." },
      {
        ...
        yPct: 16.8,
        texto:
          "Filtro por forma de pagamento — marque para revelar cada grupo. O botão \"Marcar todos\"/\"Desmarcar todos\" ao lado alterna todas de uma vez.",
      },
      {
        numero: 4,
        xPct: 16,
  ...
  },
  {
    ...
    regras: [
      ...
      "A chave no topo alterna entre \"Enviados\" (lançamentos seus, do mês selecionado, com reembolso vinculado a alguém) e \"Recebidos\" (lançamentos que outra pessoa compartilhou com você) — as duas abas são filtradas pelo mês selecionado no seletor de mês/ano.",
      "Em Enviados, o checkbox \"Enviados\" (desmarcado por padrão) controla o que a lista mostra: desmarcado, só os lançamentos ainda não enviados (com o selo \"Não enviado\"); marcado, só os já enviados (selo \"Enviado\"). A lista também traz as colunas Credor, Observação, Parcela e Reembolso.",
      "Com o checkbox \"Enviados\" marcado, o botão vira \"Reenviar Lançamento\": selecione os itens e reenvie — o sistema apaga o envio antigo e cria um novo, com uma nova notificação para quem recebe.",
      "Um item já enviado tem um botão de excluir na linha: ele só desfaz o compartilhamento (a pessoa deixa de ver aquele item pendente) — a despesa continua intacta na sua Contas a Pagar. A exclusão pergunta o alcance: apenas este mês, este mês e os futuros, ou todos desde o início (mesma mensagem já usada para excluir contas fixas em Contas a Pagar).",
      "O checkbox no cabeçalho da tabela marca ou desmarca de uma vez todos os itens visíveis na página atual.",
      "Ao compartilhar, só vai o valor que a outra pessoa deve reembolsar (100% ou 50%, conforme o modo configurado no reembolso) — nunca o valor total do lançamento.",
      "Se o lançamento selecionado for parcelado, compartilhar uma parcela compartilha automaticamente TODAS as parcelas daquele lançamento (as que ainda não tinham sido compartilhadas), não só a do mês selecionado.",
      "Se o lançamento selecionado for uma conta fixa (recorrente), compartilhar gera de uma vez as parcelas dos próximos 10 meses (mesma janela usada na tela Início) — não é preciso compartilhar mês a mês.",
      "Clicar em Compartilhar mostra uma confirmação com o nome de quem vai receber antes de enviar de verdade.",
      "Se a outra pessoa ainda não tiver \"Compartilhar Lançamentos\" ativo (ou o vínculo mútuo não existir), nada de financeiro é enviado: ela recebe uma notificação (sino) convidando a ativar, e você também recebe uma notificação avisando que está aguardando ela ativar/configurar o recebimento. Os lançamentos que você tentou enviar continuam em Enviados com o selo \"Não enviado\".",
      "Em Recebidos só aparecem os lançamentos ainda \"Não Lançado\" (o sistema não guarda histórico do que já foi lançado) — a lista também traz as colunas Credor, Observação, Parcela (ex.: \"1/3\" ou \"Fixa\") e Reembolso, com as mesmas informações do lançamento original do outro usuário.",
      ...
      "Ao lançar um recebido: o Credor vem travado com o nome de quem enviou (abreviado se for muito longo), a observação é copiada do lançamento original, a aplicação sugerida é criada automaticamente na sua lista se ainda não existir, e o lançamento nunca é do tipo Provisão nem tem reembolso associado — por isso a Provisão não aparece nas opções de forma de pagamento desse fluxo.",
      "Enquanto um recebido ainda não foi lançado, dá para excluí-lo (parcela única, fixo ou parcelado) — a exclusão pergunta o alcance: apenas este mês, este mês e os futuros, ou todos desde o início (mesma mensagem já usada para excluir contas fixas em Contas a Pagar).",
    ...
    imagemAlt: "Aba Lançamentos Compartilhados com a chave Enviados/Recebidos",
    marcadores: [
      { numero: 1, xPct: 13.6, yPct: 29.3, texto: "Alterna entre os lançamentos que você enviou e os que recebeu de outra pessoa." },
      {
        numero: 2,
        xPct: 9.6,
        yPct: 38.4,
        texto: "Compartilha os selecionados (Enviados) ou lança os selecionados na sua conta (Recebidos) — sempre com confirmação antes.",
      },
      { numero: 3, xPct: 87.3, yPct: 38.4, texto: "Navega entre os meses — filtra tanto Enviados quanto Recebidos." },
      {
        numero: 4,
        xPct: 22.9,
        yPct: 45.9,
        texto: "Lista dos lançamentos, com o selo Enviado/Não enviado (Enviados) ou Não Lançado (Recebidos).",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    regras: [
      ...
      "Não existe filtro de Aplicação aqui (diferente do Modelo I); é possível filtrar só por Forma de pagamento e Reembolso.",
      "Os resumos (por forma de pagamento, por aplicação e por reembolso) e a lista completa de lançamentos na impressão/PDF seguem a mesma lógica do Modelo I, mas sempre restritos ao que ainda está pendente no mês.",
      "\"Compartilhar\" gera um PDF e tenta abrir o menu nativo de compartilhamento do dispositivo (WhatsApp, e-mail, etc.); se o navegador não suportar, o PDF é baixado diretamente.",
    ],
    validacoes: [],
    ...
    marcadores: [
      { numero: 1, xPct: 15.9, yPct: 18.5, texto: "Filtros por forma de pagamento e reembolso — sem filtro de aplicação." },
  ...
  },
  {
    ...
    resumo:
      "Personalização das listas usadas nos formulários (formas de pagamento e aplicações) e preferências gerais: resumos do relatório, sugestão de credor, itens por página, menu e tema.",
    regras: [
    ...
    marcadores: [
      ...
      { numero: 6, xPct: 25.6, yPct: 53.7, texto: "Formas de pagamento — itens com cadeado são protegidos; balão edita a observação." },
