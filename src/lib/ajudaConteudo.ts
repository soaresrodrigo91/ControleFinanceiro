...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    regras: [
      ...
      "Um grupo pode ser marcado como favorito (ícone de estrela) — ele já vem selecionado ao abrir o formulário de novo lançamento (no site e no app mobile), mas qualquer outro grupo continua podendo ser escolhido na hora. Só um grupo pode ser favorito por vez: marcar outro troca automaticamente o anterior. Remover o grupo favorito também remove o favorito.",
