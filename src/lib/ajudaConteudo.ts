...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    regras: [
      ...
      "Cada grupo pode ter uma cor (bolinha ao lado da estrela): roxo, vermelho, amarelo, laranja, verde ou azul. A cor aparece só no nome do grupo na lista de Contas a Pagar → Lançamentos; sem cor escolhida, o grupo continua no estilo padrão.",
