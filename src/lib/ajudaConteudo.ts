...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    regras: [
      ...
      "Um lançamento criado a partir de um recebido em Lançamentos Compartilhados mostra, ao passar o mouse sobre a coluna Reembolso, o nome de quem compartilhou, o credor real e o valor real do lançamento original na conta de quem enviou (o Credor e o Valor exibidos aqui já vêm ajustados: nome de quem enviou e valor já rateado pelo modo do reembolso).",
