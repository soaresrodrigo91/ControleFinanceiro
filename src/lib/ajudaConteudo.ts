...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    regras: [
      ...
      "O campo de busca por credor filtra ao vivo, como antes, e agora também soma vários nomes ao mesmo tempo: digite um nome (ex.: \"Lisley\") e tecle Enter, ou clique numa das sugestões da lista, para transformá-lo numa etiqueta abaixo do campo — o relatório passa a somar os lançamentos de todos os credores nas etiquetas, não só do último. Digite outro nome (ex.: \"Lisley Soares\") e repita: agora os lançamentos de \"Lisley\" e de \"Lisley Soares\" são somados juntos. Cada etiqueta tem um \"×\" para remover; o nome ainda sendo digitado (sem virar etiqueta) já entra na soma ao vivo também.",
    ],
    validacoes: [
