...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    regras: [
      ...
      "Ao final das linhas de forma de pagamento, duas linhas discretas de subtotal fecham a janela: \"Subtotal\" (soma das formas de pagamento marcadas — bate com o \"Total de gastos no mês\" quando todas estiverem marcadas) e \"Líquido mensal\" (recebido do mês menos esse subtotal). As duas seguem o mesmo ícone de olho que mostra/oculta os totalizadores do topo.",
  ...
  },
  {
    ...
    regras: [
      ...
      "O card \"Mini-dashboard da Início\" controla o mini-dashboard de formas de pagamento que aparece no final da tela Início: a chave liga/desliga a exibição dele lá, e os botões escolhem entre pizza ou barras nos três gráficos.",
    ],
    validacoes: [
