...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    regras: [
      ...
      "\"Compartilhar\" gera um PDF e tenta abrir o menu nativo de compartilhamento do dispositivo (WhatsApp, e-mail, etc.); se o navegador não suportar, o PDF é baixado diretamente.",
      "Os submenus (Modelo I a IV) e a barra de filtros/ações ficam fixos no topo da tela enquanto os quadrados de totais passam por baixo deles rolando a página; assim que os quadrados terminam de passar, a barra solta e rola normalmente junto com o Top 10.",
    ],
    validacoes: [],
