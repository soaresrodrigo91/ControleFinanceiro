...
export const ARTIGOS_AJUDA: ArtigoAjuda[] = [
  ...
  },
  {
    ...
    regras: [
      ...
      "Ao lançar um recebido: o Credor vem travado com o nome de quem enviou (abreviado se for muito longo), a observação é copiada do lançamento original, e o lançamento nunca é do tipo Provisão nem tem reembolso associado — por isso a Provisão não aparece nas opções de forma de pagamento desse fluxo. Para a aplicação, o sistema usa a mesma aplicação de quem enviou quando ela já existe na sua lista; se você ainda não tiver essa aplicação cadastrada, o modal de lançamento mostra um campo extra para você escolher qual das suas aplicações usar nesse caso, em vez de criar uma nova automaticamente.",
